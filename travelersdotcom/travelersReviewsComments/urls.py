...
urlpatterns = [
 ...
 path('get/review/by/location/<int:id>/',GetLocationReviewRatingByPlace.as_view(),name='get-review-rating-by-place'),
 path('get/review/by/user/<int:id>',GetLocationReviewRatingByUser.as_view(),name='get-review-rating-by-user'),
