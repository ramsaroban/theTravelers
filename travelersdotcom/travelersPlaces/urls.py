...
urlpatterns = [
 path('get/visiting/place/by/category/<int:id>',GetVisitingPlaceByCategory.as_view(),name='get-visiting-place-by-category'),
 path('get/visiting/place/by/activity/<int:id>',GetVisitingPlaceByActivity.as_view(),name='get-visiting-place-by-activity'),
