"""travelersdotcom URL Configuration
...
schema_view = get_schema_view(
   openapi.Info(
      title="Travlers.com API",
      default_version='v1',
      description="REST API v1 for Travelers.com",
      terms_of_service="https://www.travelers.com/policies/terms/",
      contact=openapi.Contact(email="travelers.api@gmail.com"),
...
urlpatterns = [
    ...
    path('api/guide-agency/reviews/', include('guideAgencyReviewsComment.urls')),
